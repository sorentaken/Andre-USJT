...
public class CadastrarUsuarioAtendente extends JFrame
{

	private ResourceBundle bn = null;
	
	public CadastrarUsuarioAtendente()
	{
		setTitle("Cadastrar Usuario - Atendente");
		...
		JLabel a1 = new JLabel("Atendente");
