...
public class EnviarArquivoSindico extends JFrame
{
	File cript = new File("SenhaArmazenada.txt");
	private ResourceBundle bn = null;
	
	public EnviarArquivoSindico()
	{
		setTitle("Enviar Arquivo Texto - Sindico");
	    ...
	    JCheckBox AcessoLivre = new JCheckBox("Acesso Livre");
	    ...
	    portugues.addActionListener(
		         new ActionListener()
		         {
		            public void actionPerformed( ActionEvent evento )
		            {
                        ...
                        AcessoLivre.setText(bn.getString("AcessoLivre"));
